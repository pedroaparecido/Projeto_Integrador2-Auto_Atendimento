...
// import 'package:atendimento_automatico/features/order/presentation/controllers/order_controller.dart';
...
// class _ProcessingPaymentPageState extends State<ProcessingPaymentPage> with TickerProviderStateMixin {
...
//     return Scaffold(
//       body: ScopedModelDescendant<CartModel>(builder: (context, child, cart) {
...
//                           products:
//                               cart.cart.map((e) => OrderProductEntity(productId: e.id, quantity: e.qty)).toList()))
//                       .then((value) {
